...
export function QualityControlSection() {
  return (
    <section data-motion-section="quality-control" aria-labelledby="qc-heading" className="bg-background py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <MotionReveal className="max-w-2xl" direction="right">
        ...
        <ol className="mt-12 grid gap-8 sm:grid-cols-3">
          {qualityControlSteps.map((step, i) => {
            ...
            return (
              <li key={step.title}>
                <MotionReveal className="flex h-full flex-col gap-3 rounded-sm border border-border bg-card p-6" delay={i * 0.1} direction="scale">
