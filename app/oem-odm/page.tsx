...
export const metadata: Metadata = {
  title: 'OEM/ODM Costume Development',
  description: 'A clear B2B development path from inquiry and sample review through bulk production and shipment preparation.',
  alternates: { canonical: '/oem-odm' },
  openGraph: { type: 'website', url: '/oem-odm', images: ['/images/banner-2.jpg'] },
}
