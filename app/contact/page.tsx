...
export const metadata: Metadata = {
  ...
  description: 'Send product interest, quantities and garment requirements to YIDIANYUAN for an OEM/ODM wholesale discussion.',
  alternates: { canonical: '/contact' },
  openGraph: { type: 'website', url: '/contact', images: ['/images/banner-2.jpg'] },
}
